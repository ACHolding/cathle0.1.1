...
# UI — Project64 ~0.1 era (Win9x gray chrome). Emulator name stays APP_NAME / WINDOW_TITLE.
...
class ACsN64GUI:
    ...
    def _setup_ui(self):
        ...
        for txt, cmd in (
            ...
            tk.Button(
                ...
                font=UI_FONT,
                bg=PJ64_BTN_FACE,
                activebackground=PJ64_BTN_HIGHLIGHT,
                relief=tk.RAISED,
                bd=2,
    ...
    def show_about(self) -> None:
        if messagebox:
            messagebox.showinfo(
                ...
                "Python " + PYTHON_TARGET + " — " + ENGINE_NAME + " core.",
            )
    ...
    def toggle_run(self):
        """Legacy: same as Start when stopped, Stop when running."""
