...
"""
n64emu.py
N64Emu 0.1 - single-file clean-room N64 emulator core + Tkinter GUI.
...
Run:
    python3.14 n64emu.py

Optional Cython build outside the app, still using this one source file:
    python3.14 -m pip install cython
    python3.14 -m cythonize -3 -i n64emu.py
...
APP_NAME = "ac's 64emu 0.1"
ENGINE_FILE = "n64emu.py"
...
CLEANROOM_PROFILE = "PJ64_0_1_STYLE_CLEANROOM_CORE"
...
class ChatGPTN64EmuGUI:
    ...
    def build_ui(self) -> None:
        ...
        tk.Label(
            toolbar,
            text=" N64Emu 0.1 | python3.14 | cython-wrapper embedded | files off",
            bg=BG,
            fg=BLUE,
            font=("Arial", 8, "bold"),
    ...
    def render_info(self, s: Dict[str, object]) -> None:
        ...
        text = (
            ...
            f"OPS {s.get('opcode_count')} CACHE {s.get('decode_cache')} HLE {s.get('hle_calls')} MMIO {s.get('mmio_writes')} FPS 60"
        )
